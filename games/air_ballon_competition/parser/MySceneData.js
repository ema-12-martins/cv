...
class MySceneData {
  ...
  constructor() {
    ...
    this.descriptors["globals"] = [
      ...
      { name: "fog", type: "fog_def"},
      { name: "skybox", type: "skybox_def"}
    ]

    this.descriptors["fog_def"] = [
      { name: "color", type: "rgb" },
      { name: "near", type: "float" },
      { name: "far", type: "float" },
    ]

    this.descriptors["skybox_def"] = [
    ...
    this.descriptors["material"] = [
      ...
      { name: "height_map_path", type: "string", required: false, default: null },
      { name: "normal_map_path", type: "string", required: false, default: null },
    ...
    this.descriptors["orthogonal"] = [
      { name: "id", type: "string" },
      { name: "visibility", type: "boolean", required: false, default: true },
    ...
    */
    ...
    this.descriptors["lathe"] = [
      ...
      { name: "visibility", type: "boolean", required: false, default: true },
      { name: "segments", type: "integer" },
      { name: "controlpoints2D", type: "list", listOf: "controlpoint2D" },
    ]

    this.descriptors["controlpoint2D"] = [
      { name: "x", type: "float" },
      { name: "y", type: "float" }
    ]
    ...
    this.primaryNodeIds = ["globals", "textures", "materials", "cameras", "graph"]

    this.primitiveIds = ["cylinder", "rectangle","letter", "triangle", "sphere", "nurbs", "box", "model3d", "polygon", "road","lathe"]
  ...
  addChildToNode(node, child) {
    ...
    if (node.type === "lod"){
      if (node.lodNodes === undefined) {
        throw new Error("inconsistency: a node has an undefined array of lodNodes!");
      }
  
      node.lodNodes.push(child)
      console.debug("added lod child" + JSON.stringify(child));
