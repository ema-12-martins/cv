...
export default function ExpenseUpdateScreen() {
  ...
  useEffect(() => {
    ...
    const fetchExpense = async () => {
      try {
        const res = await fetch(`${api_url}/expenses/${incomeId}`);
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch(`${api_url}/expenses/${incomeId}`, {
        method: 'PUT',
        headers: {
  ...
  return (
    <BackgroundLayout title="Edit Expense">
      <BottomSheet>
